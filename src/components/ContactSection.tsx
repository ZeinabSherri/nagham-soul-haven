            ...
            <Card className="bg-gray-50 border-2 border-deep-purple/20 shadow-lg">
              <CardContent className="p-6">
                ...
                <div className="flex space-x-4">
                  <button onClick={() => handleSocialClick('Instagram', 'https://www.instagram.com/naghamthecoach/')} className="w-12 h-12 bg-vibrant-purple hover:bg-deep-purple rounded-full flex items-center justify-center text-white transition-colors duration-300 transform hover:scale-110 touch-manipulation" aria-label="Instagram" style={{
                  WebkitTapHighlightColor: 'rgba(163, 57, 156, 0.3)'
                }}>
                    <Instagram className="w-6 h-6" />
                  </button>
                  <button onClick={handleWhatsAppClick} className="w-12 h-12 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center text-white transition-colors duration-300 transform hover:scale-110 touch-manipulation" aria-label="WhatsApp" style={{
                  ...
                  <button onClick={() => handleSocialClick('YouTube', 'https://www.youtube.com/@NaghamTheCoach')} className="w-12 h-12 bg-red-600 hover:bg-red-700 rounded-full flex items-center justify-center text-white transition-colors duration-300 transform hover:scale-110 touch-manipulation" aria-label="YouTube" style={{
                  WebkitTapHighlightColor: 'rgba(220, 38, 38, 0.3)'
                }}>
                    <Youtube className="w-6 h-6" />
                  </button>
                  <button onClick={() => handleSocialClick('TikTok', 'https://www.tiktok.com/@naghamthecoach')} className="w-12 h-12 bg-black hover:bg-gray-800 rounded-full flex items-center justify-center text-white transition-colors duration-300 transform hover:scale-110 touch-manipulation" aria-label="TikTok" style={{
