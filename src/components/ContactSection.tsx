...
const ContactSection = () => {
  ...
  const handleBookSessionClick = () => {
    window.open('https://calendly.com/hello-naghamthecoach/book-your-session', '_blank');
  };
          ...
          <Card className="max-w-4xl mx-auto bg-white border-2 border-deep-purple/20 shadow-xl">
            ...
            <CardContent className="text-center">
              ...
              <div className="bg-gray-50 rounded-xl p-8 border border-deep-purple/10">
                ...
                <Button onClick={handleBookSessionClick} className="bg-deep-purple hover:bg-vibrant-purple text-white px-8 py-3 text-lg font-semibold rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 mb-4">Book 60 min session</Button>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="text-deep-purple">Lebanon: Dawhet el Hoss, Lebanon (Online sessions available worldwide)</span>
                  </div>
                  <div className="flex items-center space-x-4">
                    <MapPin className="w-6 h-6 text-vibrant-purple" />
