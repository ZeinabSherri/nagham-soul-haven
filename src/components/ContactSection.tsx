            ...
            <CardContent className="text-center">
              <div className="mb-6">
                <Button 
                  ...
                  className="bg-vibrant-purple hover:bg-deep-purple text-white px-8 py-3 text-lg font-semibold rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 touch-manipulation"
                >
                  Book a Call Now
                </Button>
              </div>
            ...
            <Card className="bg-white border-2 border-deep-purple/20 shadow-lg">
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div 
                    className="flex items-center space-x-4 cursor-pointer hover:text-vibrant-purple transition-colors touch-manipulation" 
              ...
              <CardContent className="p-6">
                ...
                <div className="flex space-x-4">
                  <button
                    ...
                    className="w-12 h-12 bg-vibrant-purple hover:bg-deep-purple rounded-full flex items-center justify-center text-white transition-colors duration-300 transform hover:scale-110 touch-manipulation"
