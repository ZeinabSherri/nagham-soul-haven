...
const ContactSection = () => {
  ...
  return <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-white/50">
          ...
          <Card className="max-w-4xl mx-auto bg-gradient-to-br from-rose-50 to-amber-50 border-2 border-rose-200 shadow-xl">
            ...
            <CardContent className="text-center">
              <div className="bg-white/60 rounded-xl p-8 border border-amber-200">
                ...
                <Button onClick={handleCalendlyClick} className="bg-rose-500 hover:bg-rose-600 text-white px-8 py-3 text-lg font-semibold rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
          ...
          <Card className="bg-gradient-to-br from-amber-50 to-rose-50 border-2 border-amber-200 shadow-lg">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <Input type="text" name="name" placeholder="Your Name" value={formData.name} onChange={handleInputChange} className="bg-white/70 border-amber-300 focus:border-rose-400" />
                </div>
                <div>
                  <Input type="email" name="email" placeholder="Your Email" value={formData.email} onChange={handleInputChange} className="bg-white/70 border-amber-300 focus:border-rose-400" />
                </div>
                <div>
                  <Textarea name="message" placeholder="Tell me a bit about what you're looking for..." value={formData.message} onChange={handleInputChange} className="bg-white/70 border-amber-300 focus:border-rose-400 min-h-32" />
                </div>
                <Button type="submit" className="w-full bg-rose-500 hover:bg-rose-600 text-white py-3 rounded-full font-semibold transition-all duration-300">
                  Send Message
                </Button>
              </form>
            </CardContent>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="text-amber-800">Online & In-Person Sessions</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-amber-50 to-green-50 border-2 border-amber-200 shadow-lg">
              <CardContent className="p-6">
                ...
                <div className="flex space-x-2">
                  <Input type="email" placeholder="Your email" className="bg-white/70 border-amber-300" />
