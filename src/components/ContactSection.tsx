          ...
          <Card className="max-w-4xl mx-auto bg-white border-2 border-deep-purple/20 shadow-xl">
            ...
            <CardContent className="text-center">
              <div className="bg-gray-50 rounded-xl p-8 border border-deep-purple/10">
                ...
                <Button onClick={handleCalendlyClick} className="bg-deep-purple hover:bg-vibrant-purple text-white px-8 py-3 text-lg font-semibold rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
            ...
            <Card className="bg-white border-2 border-deep-purple/20 shadow-lg">
              <CardContent className="p-6">
                ...
                <div className="flex space-x-2">
                  <Input type="email" placeholder="Your email" className="bg-white border-deep-purple/30 focus:border-vibrant-purple" />
