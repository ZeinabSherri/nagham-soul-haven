      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[75vh]">
          ...
          <div className="text-left">
            ...
            {/* Subheadline */}
            <p className="text-xl md:text-2xl text-vibrant-purple mb-10 leading-relaxed animate-fade-in delay-300 font-normal">I'm Nagham, Your Guide to Transformation.<br> I help you <strong>Release</strong> what's heavy, <strong>Reconnect</strong> with yourself, and <strong>Rise</strong> into who you were always meant to be.</br></p>
