    ...
    <section id="services-section" className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 animate-fade-in">
          <h2 id="services-title" className="text-4xl md:text-5xl font-bold text-deep-purple text-left scroll-mt-32">
            My Services
          </h2>
          <p className="text-lg text-dark-olive mt-4 animate-fade-in delay-200">
            Each healing session is uniquely designed for you, combining ancient wisdom with modern therapeutic techniques for profound transformation.
          </p>
        </div>
