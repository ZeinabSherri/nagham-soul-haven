  ...
  return (
    <section id="certifications" className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-creamy-beige rounded-xl p-6 border-2 border-light-olive mb-12">
        ...
        <div className="bg-light-lavender-pink rounded-xl p-6 border-2 border-soft-lavender">
          <h3 className="text-xl font-bold mb-6 text-left text-deep-purple">
            Perfect for You If...
          </h3>
