    ...
    <section id="certifications-section" className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          {/* Certification Carousel - Mobile Optimized */}
          <div className="animate-fade-in delay-300 w-full">
            <div className="bg-gradient-to-br from-soft-lavender to-light-lavender-pink p-4 sm:p-8 rounded-2xl shadow-lg">
              ...
              {/* Mobile-Optimized Carousel Container - No Horizontal Overflow */}
              <div className="w-full max-w-full">
                <Carousel className="w-full" opts={{ align: "center", loop: true }}>
                  <CarouselContent className="-ml-1 sm:-ml-4">
                    {certifications.map((cert, index) => (
                      <CarouselItem key={index} className="pl-1 sm:pl-4 basis-full max-w-full">
                        <div className="w-full max-w-sm mx-auto">
                          <Card className="border-2 border-white shadow-md hover:shadow-lg transition-shadow duration-300 w-full">
                            <CardContent className="p-4 sm:p-6">
                              <div className="aspect-square flex items-center justify-center mb-4 bg-white rounded-lg p-2 sm:p-4 max-w-full">
                                <img 
                                  src={cert.logo} 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {additionalTrainings.map((training, index) => (
                  <div key={index} className="flex items-center space-x-2 p-2 bg-white/70 rounded-md">
                    ...
                    <span className="text-deep-purple text-xs sm:text-sm font-medium min-w-0 break-words">
                      {training}
                    </span>
                  </div>
                ))}
