      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:block">
            <Button onClick={() => scrollToSection('contact')} className="bg-deep-purple hover:bg-vibrant-purple text-white px-6 py-2 rounded-lg font-bold transition-all duration-300 hover:scale-105">
              Book Session
            </Button>
          </div>
        ...
        {isOpen && <div className="md:hidden py-4 space-y-4 border-t border-soft-lavender">
            ...
            <Button onClick={() => scrollToSection('contact')} className="bg-deep-purple hover:bg-vibrant-purple text-white px-6 py-2 rounded-lg w-full font-bold hover:scale-105 transition-all duration-300">
              Book Session
            </Button>
          </div>}
      </div>
